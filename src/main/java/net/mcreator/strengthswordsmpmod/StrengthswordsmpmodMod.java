 ...
 *
 */
package net.mcreator.strengthswordsmpmod;
...
@Mod("strengthswordsmpmod")
public class StrengthswordsmpmodMod {
	public static final Logger LOGGER = LogManager.getLogger(StrengthswordsmpmodMod.class);
	public static final String MODID = "strengthswordsmpmod";

	public StrengthswordsmpmodMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();

		StrengthswordsmpmodModItems.REGISTRY.register(bus);
